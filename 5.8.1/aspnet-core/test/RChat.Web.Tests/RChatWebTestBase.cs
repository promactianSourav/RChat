...
{
    public abstract class RChatWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static RChatWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(RChatWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<RChatDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<RChatDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<RChatDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<RChatDbContext, Task<T>> func)
        {
            T result;
